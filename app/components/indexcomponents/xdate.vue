	...
	export default {
		...
		methods: {
			getTime() {
				...
				var INmonths = (''+this.datee[0].getMonth()).length<2?"0"+(this.datee[0].getMonth()+1):this.datee[0].getMonth()+1
		...
		//	默认时间为今天
			var reg = /\//g
			scope.hotelInformation.starTime = new Date().toLocaleDateString().replace(reg, "-")
		}
	}
</script>
